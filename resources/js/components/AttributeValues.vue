                ...
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tr v-for="value in values" >
                            <td style="width: 25%" class="text-center"  :key="value.id">{{  value.id}}</td>
                            <td style="width: 25%" class="text-center"  :key="value.value">{{ value.value}}</td>
                            <td style="width: 25%" class="text-center"  :key="value.price">{{ value.price}}</td>
